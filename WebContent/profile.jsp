...
.button {
	...
	font-size: 16px;
	margin-top: 39px text-decoration: none;
	border-radius: 8px;
}
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">Profile Updation
										form</h4>
								</div>
									...
									<div class="form-group">
										...
										<div class="input-group pb-modalreglog-input-group">
											<input type="text" class="form-control" id="adminaddress"
												name="adminaddress" placeholder="address"
												required="required" value="<%=rs.getString(3)%>"> <span
												class="input-group-addon"><span
												class="glyphicon glyphicon-lock"></span></span>
										</div>
									</div>
