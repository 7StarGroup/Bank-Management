...
<body>
	...
	<table id="table" border="2px solid blue">
		...
		<tr>
			...
			<td style="text-align: center;"><a href="#myModal1"
				class="button" data-toggle="modal" style="text-decoration: none;">Edit</a></td>
			<td style="text-align: center;"><a href="#myModal2"
				class="button" data-toggle="modal" style="text-decoration: none;"><i
									...
									<div class="form-group">
										...
										<div class="input-group pb-modalreglog-input-group">
											<input type="text" class="form-control" id="loanId"
												name="loanId" placeholder=<%=eid + 1%>> <span
									...
									<div class="form-group">
										...
										<div class="input-group pb-modalreglog-input-group">
											<input type="text" class="form-control" id="loanType"
												name="loanType" placeholder="Name" required="required">
									...
									<div class="form-group">
										...
										<div class="input-group pb-modalreglog-input-group">
											<input type="text" class="form-control" id="interest"
												name="interest" placeholder="Address" required="required">
											<span class="input-group-addon"><span
												class="glyphicon glyphicon-lock"></span></span>
										</div>
									</div>
										...
										<div class="form-group">
										<label for="Interest">Years</label>
										<div class="input-group pb-modalreglog-input-group">
											<input type="text" class="form-control" id="years"
												name="years" placeholder="Address" required="required">
											<span class="input-group-addon"><span
												class="glyphicon glyphicon-lock"></span></span>
										</div>
									</div>
	...
	<script type="text/javascript">
		...
		for (var i = 1; i < table.rows.length; i++) {
			table.rows[i].onclick = function() {
				...
				document.getElementById("loanId").value = this.cells[0].innerHTML;
				document.getElementById("loanType").value = this.cells[1].innerHTML;
				document.getElementById("interest").value = this.cells[2].innerHTML;
				document.getElementById("years").value = this.cells[3].innerHTML;
