...
try
{
	stmt=con.prepareStatement("select user_name,account_id from user,account,user_account where user.user_id=user_account.user_id_fk and account.account_id=user_account.account_id_fk and creditcard_applied=1");
