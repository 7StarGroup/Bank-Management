...
try
{
	stmt=con.prepareStatement("select is_deleted,avail_bal from user_account where user_id_fk=?");
	...
	if(rs.next())
	{
		...
		else
		{
			...
			{	
				...
				{
					out.println("<script>");
					out.println("alert('Applied successfully for closing account !!!');window.location = 'http://localhost:8080/Bank/HomeScreen.jsp';");
					out.println("</script>");
				}
			}
		}
