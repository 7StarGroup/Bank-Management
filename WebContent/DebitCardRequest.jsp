...
<form action="DebitCardAction" method="post">
<table>
<col width="200px">
<col width="200px">
...
try
{
	stmt=con.prepareStatement("select user_name,account_id from user,account,user_account where user.user_id=user_account.user_id_fk and account.account_id=user_account.account_id_fk and debitcard_applied=1");
