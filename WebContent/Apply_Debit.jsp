...
<body>
	...
	<form action="DebitRequest" method="post">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-75">
					<input type="text" name="accountnumber" placeholder="userId"
						disabled>
				</div>
				<!-- 	<div class="col-75">
			...
			<div class="row">
				...
				<div class="col-75">
					<input type="text" name="moblie" value=<%=rs.getString(3)%>
						disabled>
				</div>
			</div>
			<div class="row"></div>
			<div class="row">
				...
				<div class="col-75">
					...
					<div class="col-25">
					<label for="reason"><b>Card Type</b></label>
				</div>
